...
void Audio::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	// try to get everything from this if you can
	// this does not constantly update though, unlike in PerformLayout()
	// it does reload everytime you open it though, so thats fine
